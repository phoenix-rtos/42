...
ifeq ($(42PLATFORM),__linux__)
   ...
   NOS3OBJ = $(OBJ)42nos3.o 
   XWARN = -Wno-unused-variable -Wno-unused-but-set-variable -Wno-stringop-overread -Wno-unused-result
   EXENAME = 42
   CC = gcc
endif
...
CFLAGS = -std=c11 -g -O2 -fpic -Wall -Wshadow -Wno-deprecated $(XWARN) $(ANSIFLAGS) $(GLINC) $(CINC) -I $(INC) -I $(KITINC) -I $(KITSRC) $(GMSECINC) $(ARCHFLAG) $(GUIFLAG) $(GUI_LIB) $(SHADERFLAG) $(CFDFLAG) $(FFTBFLAG) $(GSFCFLAG) $(GMSECFLAG) $(STANDALONEFLAG)
